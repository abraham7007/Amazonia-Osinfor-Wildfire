// T08 — Medida de bateria y testigo de consumo.
//
// Dos cosas distintas:
//
...
#else
  dato("esta placa no tiene pin de bateria fijado en include/placa.h");
  dato("el NE101 expone la medida por la cabecera de 16 pines: definir PLACA_PIN_BATERIA");
  dato("mientras tanto el firmware reporta SoC nominal y la politica de ahorro no actua");
#endif
